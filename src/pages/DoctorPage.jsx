import { ArrowLeft, MapPin, Calendar, Clock, Star, Check, Phone, ChevronRight } from 'lucide-react'
      ...
      <div className="pb-24">
        ...
        <div className="bg-white p-6 text-center border-b">
          {doctor.image ? (
            ...
            <div className={`w-24 h-24 rounded-full mx-auto mb-3 border-4 border-blue-100 flex items-center justify-center text-white font-bold text-2xl ${doctor.avatarBg}`}>
              {doctor.avatar}
            </div>
          )}
          ...
          <div className="flex justify-center gap-6 mt-4 text-sm">
            ...
            <div className="text-gray-600">{doctor.experience || '0 yil'} tajriba</div>
            <div className="text-gray-600">{doctor.patients || '0'} bemor</div>
          </div>
        </div>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <h3 className="font-bold text-gray-900 mb-2 text-base">Shifokor haqida</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
              {doctor.name} — {doctor.specialization} bo'yicha mutaxassis.
              {doctor.experience ? ` ${doctor.experience} tajribaga ega.` : ''}
              {doctor.subspecialty ? ` Yo'nalishi: ${doctor.subspecialty}.` : ''}
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
              <Calendar size={18} className="text-primary" /> Bugungi qabullar
            </h3>
            <p className="text-sm text-gray-700">{todayAppointments.length} ta qabul</p>
          </div>
